...
use crate::async_bridge::{AdeleOutput, UiMessage};

/// Shared mutable state for the window.
#[derive(Default)]
pub(super) struct WindowState {
    pub(super) conversations: Vec<ConversationSummary>,
    pub(super) current_conversation_id: Option<String>,
    pub(super) current_conversation: Option<ConversationDetail>,
...
impl WindowState {
    ...
    pub(super) fn voice_in_for_current(&self) -> bool {
    ...
    /// never set (default Disabled).
    pub(super) fn adele_output_for_current(&self) -> AdeleOutput {
        self.current_conversation_id
            .as_deref()
...
/// not advertised here.)
pub(super) fn voice_mode_client_tools() -> Vec<api::ClientToolRegistration> {
...
impl WindowState {
    ...
    pub(super) fn apply(&mut self, msg: UiMessage) -> Vec<Effect> {
        match msg {
